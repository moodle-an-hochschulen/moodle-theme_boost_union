...
define('THEME_BOOST_UNION_SETTING_SECTIONAPPEARANCE_COLLAPSIBLEEXPANDED', 'collapsibleexpanded');
define('THEME_BOOST_UNION_SETTING_SECTIONAPPEARANCE_COLLAPSIBLECOLLAPSED', 'collapsiblecollapsed');
define('THEME_BOOST_UNION_SETTING_SECTIONAPPEARANCE_NOTCOLLAPSIBLE', 'notcollapsible');
define('THEME_BOOST_UNION_SETTING_SECTIONAPPEARANCE_HIDDEN', 'hidden');
...
define('THEME_BOOST_UNION_SETTING_LOGINARRANGEMENT_SIDEBYSIDE', 'sidebyside');
define('THEME_BOOST_UNION_SETTING_LOGINARRANGEMENT_LEGACY', 'legacy');
...
define('THEME_BOOST_UNION_SETTING_LOGINDIVIDERTYPE_NONE', 'none');
define('THEME_BOOST_UNION_SETTING_LOGINDIVIDERTYPE_MARGIN', 'margin');
define('THEME_BOOST_UNION_SETTING_LOGINDIVIDERTYPE_LINE', 'line');
define('THEME_BOOST_UNION_SETTING_LOGINDIVIDERTYPE_LINEWITHOR', 'linewithor');
...
define('THEME_BOOST_UNION_SETTING_OUTSIDEREGIONSVERTICALALIGN_DEFAULT', 0);
define('THEME_BOOST_UNION_SETTING_OUTSIDEREGIONSVERTICALALIGN_PAGECONTENT', 1);
define('THEME_BOOST_UNION_SETTING_OUTSIDEREGIONSWRAPPING_ABOVEBELOW', 0);
define('THEME_BOOST_UNION_SETTING_OUTSIDEREGIONSWRAPPING_BOTHBELOW', 1);
