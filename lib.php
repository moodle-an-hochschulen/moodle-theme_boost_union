...
define('THEME_BOOST_UNION_SETTING_AIPLACEMENT_COURSEASSIST_LOCATION_DEFAULT', 'default');
define('THEME_BOOST_UNION_SETTING_AIPLACEMENT_COURSEASSIST_LOCATION_HEADERACTION', 'headeraction');
