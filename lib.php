...
function theme_boost_union_get_pre_scss($theme) {
    ...
    if (isset($theme->settings->blockregionoutsideleftwidth)) {
        $scss .= '$blockregionoutsideleftwidth: '.$theme->settings->blockregionoutsideleftwidth.";\n";
    }
    if (isset($theme->settings->blockregionoutsiderightwidth)) {
        $scss .= '$blockregionoutsiderightwidth: '.$theme->settings->blockregionoutsiderightwidth.";\n";
    }
