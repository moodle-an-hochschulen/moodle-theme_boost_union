 ...
 * @copyright  2026 RubliX (Toshimi Hatanaka) - https://www.rublix.jp
...
$string['courseheaderimageplusfallback'] = 'コースヘッダー画像';// This string is just there to make the help_icon class happy but is not used anywhere.
$string['courseheaderimageplusfallback_help'] = 'コースページ上部のコースヘッダーに表示される画像です。ここに画像をアップロードしない場合、グローバルコースヘッダー画像が使用されます。';
$string['courseheaderimagenofallback'] = 'コースヘッダー画像'; // This string is just there to make the help_icon class happy but is not used anywhere.
$string['courseheaderimagenofallback_help'] = 'コースページ上部のコースヘッダーに表示される画像です。ここに画像をアップロードしない場合、コースタイトルのみが表示されます。';
$string['courseheaderimagenoimage'] = 'コースヘッダー画像'; // This string is just there to make the help_icon class happy but is not used anywhere.
