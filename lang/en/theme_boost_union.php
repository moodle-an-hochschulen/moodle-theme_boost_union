...
$string['loginidpbuttoncolorenablesetting'] = 'IDP login button color';
$string['loginidpbuttoncolorenablesetting_desc'] = 'By enabling this setting, the OAuth2 / IDP login buttons on the login page will use the theme\'s primary color as their background color. If disabled, the buttons will use the default unstyled appearance from Boost core. Note: This behaviour was intentionally introduced in Boost Union (see the README for details).';
...
$string['loginidpbuttoncolorenablesetting'] = 'IDP login button color';
$string['loginidpbuttoncolorenablesetting_desc'] = 'By enabling this setting, the IDP / OAuth2 login buttons will use the theme\'s primary color as their background color. If disabled, the IDP login buttons will use the default unstyled appearance from Boost core. Note: This is a deviation from Boost core which was intentionally introduced in Boost Union (see the README for details).';
