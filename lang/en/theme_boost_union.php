...
$string['smartmenu:location:main'] = 'Main';
$string['smartmenu:location:menu'] = 'Menu bar';
$string['smartmenu:location:user'] = 'User';
$string['smartmenu:location:bottom'] = 'Bottom';
...
$string['smartmenu:filtered'] = 'Show courses as filtered';
