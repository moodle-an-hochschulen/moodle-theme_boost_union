...
$string['snippetsoverview_notes3'] = 'After each change which you make on this page, the theme cache is purged. This is necessary to make sure that the compiled SCSS code which is shipped to the browser is up-to-date and might take some seconds. However, due to the way how purging the cache in Moodle works, you might have to reload the page a second time to eventually see the changes in your own browser.';
...
$string['uploadedsnippets_desc'] = 'Here, you can upload SCSS snippets to be available in this Moodle instance. You can either upload individual SCSS snippet files or a ZIP archive containing multiple SCSS snippet files – the ZIP file will be automatically extracted and the contained SCSS snippets will then be avaiable in this file area as individual files.';
