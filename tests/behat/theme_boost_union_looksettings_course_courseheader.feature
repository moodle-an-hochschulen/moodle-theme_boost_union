...
Feature: Configuring the theme_boost_union plugin for the "Course header" section on the "Course" tab on the "Look" page
  ...
  Scenario: Setting: Course header - Display the course header for the courseplusglobal image source variant
    ...
    And I upload "theme/boost_union/tests/fixtures/login_bg1.png" file to "Global course header image" filemanager
  ...
  Scenario Outline: Setting: Course header - Display the course header with the image of the current course (and not another course by mistake)
    ...
    And I click on "Settings" "link"
    And I expand all fieldsets
    And I upload "theme/boost_union/tests/fixtures/login_bg1.png" file to "<filearealabel>" filemanager
    And I press "Save and display"
    And I am on "Course 2" course homepage
    And I click on "Settings" "link"
    And I expand all fieldsets
    And I upload "theme/boost_union/tests/fixtures/login_bg2.png" file to "<filearealabel>" filemanager
    And I press "Save and display"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
    ...
    Examples:
      | source              | filearealabel       | fileaareatech                         |
      | courseplusglobal    | Course image        | course/overviewfiles                  |
      | coursenoglobal      | Course image        | course/overviewfiles                  |
      | dedicatedplusglobal | Course header image | theme_boost_union/courseheaderimage/0 |
      | dedicatednoglobal   | Course header image | theme_boost_union/courseheaderimage/0 |
  ...
  Scenario: Setting: Course header - Define the course header layout (per course).
    ...
    And I click on "Settings" "link"
    And I expand all fieldsets
    And I should not see "Course header layout" in the "#id_theme_boost_union_course_courseheaderhdr" "css_element"
    ...
    And I am on "Course 1" course homepage
    Then "//div[@id='courseheaderimage']" "xpath_element" should exist
    And "#courseheaderimage.courseheaderimage-light" "css_element" should exist in the "#page-header" "css_element"
    And "div.d-flex.align-items-center + #courseheaderimage" "css_element" should not exist in the "#page-header" "css_element"
  ...
  Scenario: Setting: Course header - Define the course header (min-)height (per course).
    ...
    And I click on "Settings" "link"
    And I expand all fieldsets
    And I should not see "Course header height" in the "#id_theme_boost_union_course_courseheaderhdr" "css_element"
    And the following config values are set as admin:
      | config                            | value | plugin            |
  ...
  Scenario: Setting: Course header - Define the course header image position (per course).
    ...
    And I click on "Settings" "link"
    And I expand all fieldsets
    And I should not see "Course header image position" in the "#id_theme_boost_union_course_courseheaderhdr" "css_element"
    And the following config values are set as admin:
      | config                                   | value | plugin            |
  ...
  Scenario: Setting: Course header - Course header layouts exclusion list excludes selected layouts from being used
    ...
    And I reload the page
    And "#courseheaderimage.courseheaderimage-light" "css_element" should not exist in the "#page-header" "css_element"
    And "div.d-flex.align-items-center + #courseheaderimage" "css_element" should exist in the "#page-header" "css_element"
