        ...
        if ($this->page->pagelayout == 'course') {
            ...
            if (coursesettings::get_config_with_course_override('courseheaderenabled') == THEME_BOOST_UNION_SETTING_SELECT_YES) {
                ...
                if (empty($courseheaderimageurl) &&
                    ...
                    // Additionally, set text on image color classes and text color properties based on setting.
                    $courseheadertextonimagecolor = coursesettings::get_config_with_course_override('courseheadertextonimagecolor');
                    switch($courseheadertextonimagecolor) {
                        case THEME_BOOST_UNION_SETTING_COURSEHEADERTEXTCOLOR_WHITE:
                            $header->textonimagecolor = 'text-white';
                            break;
                        case THEME_BOOST_UNION_SETTING_COURSEHEADERTEXTCOLOR_BLACK:
                            $header->textonimagecolor = 'text-dark';
                            break;
                    }
                    ...
                    if (get_config('theme_boost_union', 'courseheadershowediticon') == THEME_BOOST_UNION_SETTING_SELECT_YES &&
                            $this->page->user_is_editing()) {
                        $header->showcourseediticon = true;
                        // Get the course settings URL with the course header settings as anchor.
                        $header->coursesettingsurl = new moodle_url('/course/edit.php', ['id' => $this->page->course->id],
