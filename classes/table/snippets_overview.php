    ...
    public function col_actions($data) {
        ...
        if ($data->enabled == false) {
            $actions[] = [
                ...
                'attributes' => ['class' => 'action-enable py-0 pl-0 ml-0 mr-0'],
            ];
        } else {
            $actions[] = [
                'url' => new \core\url(
                ...
                'attributes' => ['class' => 'action-disable py-0 pl-0 ml-0 mr-0'],
            ];
        }
        ...
        $actions[] = [
            ...
            'attributes' => ['class' => 'action-details py-0 pe-0 ml-0 mr-0',
                    'data-action' => 'details',
