...
class smartmenus_menus extends \core_table\sql_table {
    ...
    public function col_actions($data) {
        ...
        $actions[] = [
            ...
            'attributes' => ['class' => 'action-copy py-0 ml-0 mr-0'],
        ];
        ...
        $actions[] = [
            ...
            'attributes' => ['class' => 'action-list-items py-0 ml-0 mr-0'],
        ];
