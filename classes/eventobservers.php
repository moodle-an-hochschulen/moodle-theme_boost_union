...
class eventobservers {
    ...
    public static function cohort_deleted(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::purge_cache_deleted_cohort($event->objectid);
    }
    ...
    public static function cohort_member_added(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::purge_cache_session_cohort($event->objectid, $event->relateduserid);
    }
    ...
    public static function role_assigned(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::purge_cache_session_roles($event->objectid, $event->relateduserid);
    }
    ...
    public static function role_deleted(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::purge_cache_deleted_roles($event->objectid);
    }
    ...
    public static function course_updated(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::purge_cache_dynamic_courseitems();
    ...
    public static function completion_updated(\core\event\base $event) {
        ...
        \theme_boost_union_smartmenu_helper::set_user_purgecache($event->relateduserid);
    }
