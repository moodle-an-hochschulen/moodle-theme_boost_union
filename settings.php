    ...
    // Create full settings page structure.
        ...
        if ($registerfontsresult == true) {
            ...
            $setting = new admin_setting_configstoredfilealwayscallback($name, $title, $description, 'fontawesome', 0,
                    ['maxfiles' => -1, 'subdirs' => 1, 'accepted_types' => theme_boost_union_get_fontawesome_extensions()]);
        } else {
            // Use our enhanced implementation of admin_setting_configstoredfile to circumvent MDL-59082.
            // This can be changed back to admin_setting_configstoredfile as soon as MDL-59082 is fixed.
            $setting = new admin_setting_configstoredfilealwayscallback($name, $title, $description, 'fontawesome', 0,
        ...
        if ($faconfig != THEME_BOOST_UNION_SETTING_FAVERSION_NONE && $faconfig != null &&
            ...
            // Append the file list to the description.
            $templatecontext = ['files' => theme_boost_union_get_fontawesome_templatecontext()];
        ...
        if ($faconfig != THEME_BOOST_UNION_SETTING_FAVERSION_NONE && $faconfig != null &&
            ...
            $templatecontext = ['checks' => theme_boost_union_get_fontawesome_checks_templatecontext()];
        ...
        $staticpagesurl = new moodle_url('/admin/settings.php', ['section' => 'theme_boost_union_content'],
        ...
        $sitesupporturl = new moodle_url('/user/contactsitesupport.php');
        ...
        $sitesupportsettingsurl = new moodle_url('/admin/settings.php', ['section' => 'supportcontact']);
