...
// Set page URL.
$PAGE->set_url('/theme/boost_union/pages/maintenance.php');
...
$PAGE->add_body_class('theme_boost_union-maintenance');

// Get theme config.
$config = get_config('theme_boost_union');

// If the maintenance page is disabled, we just show a short friendly warning page and are done.
if ($config->enablemaintenance != THEME_BOOST_UNION_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('maintenancedisabled', 'theme_boost_union'),
...
// Set page title.
$PAGE->set_title(theme_boost_union_get_staticpage_pagetitle('maintenance'));
