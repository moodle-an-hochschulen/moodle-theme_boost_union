...
function xmldb_theme_boost_union_upgrade($oldversion) {
    ...
    if ($oldversion < 2024100714) {
        ...
        $field = new xmldb_field('hiddencoursesort', XMLDB_TYPE_INTEGER, '9', null, null, null, null, 'listsort');
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2024100714, 'theme', 'boost_union');
    }
