...
function xmldb_theme_boost_union_upgrade($oldversion) {
    ...
    if ($oldversion < 2023090111) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023090111, 'theme', 'boost_union');
    }

    if ($oldversion < 2023090112) {
    ...
    if ($oldversion < 2023090130) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023090130, 'theme', 'boost_union');
    }
