...
function xmldb_theme_boost_union_upgrade($oldversion) {
    ...
    if ($oldversion < 2023010546) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010546, 'theme', 'boost_union');
    }

    if ($oldversion < 2023010552) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010552, 'theme', 'boost_union');
    }

    if ($oldversion < 2023010572) {
    ...
    if ($oldversion < 2023010576) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010576, 'theme', 'boost_union');
    }

    if ($oldversion < 2023010577) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010577, 'theme', 'boost_union');
    }

    if ($oldversion < 2023010579) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010579, 'theme', 'boost_union');
    }

    if ($oldversion < 2023010581) {
        ...
        // Boost_union savepoint reached.
        upgrade_plugin_savepoint(true, 2023010581, 'theme', 'boost_union');
    }
